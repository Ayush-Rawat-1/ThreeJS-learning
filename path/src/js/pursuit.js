...
const pursuerGeometry = new THREE.ConeGeometry(0.1, 0.5, 8);
...
const evaderGeometry=new THREE.SphereGeometry(0.1);
...
const pursuitBehaviour=new YUKA.PursuitBehavior(evader,3);
pursuer.steering.add(pursuitBehaviour);
